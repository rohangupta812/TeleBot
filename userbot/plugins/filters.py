...
@telebot.on(admin_cmd(sudo_cmd(pattern="savefilter (.*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern="listfilters")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern="clearfilter (.*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern="clearallfilters")))
