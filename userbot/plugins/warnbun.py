...
@borg.on(admin_cmd(sudo_cmd(pattern="warn1")))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(sudo_cmd(pattern="warn2")))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(sudo_cmd(pattern="warn3")))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(sudo_cmd(pattern="warn0")))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(sudo_cmd(pattern="ocb")))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(sudo_cmd(pattern="fw")))
async def _(event):
    if event.fwd_from:
        return
