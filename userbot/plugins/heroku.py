...
@telebot.on(admin_cmd(pattern=r"(set|get|del) var(?: |$)(.*)(?: |$)([\s\S]*)"))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"usage(?: |$)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern="info heroku")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"logs")))
