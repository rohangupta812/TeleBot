...
@borg.on(admin_cmd(sudo_cmd(pattern="sthink (.*)")))
...
n = str(ALIVE_NAME) if ALIVE_NAME else "Set ALIVE_NAME in config vars in Heroku"        
@borg.on(admin_cmd(sudo_cmd(pattern="sdick (.*)")))
...
n = str(ALIVE_NAME) if ALIVE_NAME else "Set ALIVE_NAME in config vars in Heroku"        
@borg.on(admin_cmd(sudo_cmd(pattern="sfrog (.*)")))
...
@borg.on(admin_cmd(sudo_cmd(pattern="sputin (.*)")))
...
@borg.on(admin_cmd(sudo_cmd(pattern="sdead (.*)")))
...
@borg.on(admin_cmd(sudo_cmd(pattern="strump (.*)")))
...
@borg.on(admin_cmd(sudo_cmd(pattern="schina (.*)")))
...
@borg.on(admin_cmd(sudo_cmd(pattern=r"spika")))
async def kakashi(pikachu):
    await pikachu.edit(F)
    
@borg.on(admin_cmd(sudo_cmd(pattern=r"sshit")))
async def kakashi(shit):
    await shit.edit(G)
    
@borg.on(admin_cmd(sudo_cmd(pattern=r"sxx")))
async def kakashi(saxy):
    await saxy.edit(H)
    
@borg.on(admin_cmd(sudo_cmd(pattern=r"sporn")))
