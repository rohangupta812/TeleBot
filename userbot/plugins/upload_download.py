...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"dl(?: |)(.*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"uploadir (.*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"ul (.*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"uploadas(stream|vn|all) (.*)")))
