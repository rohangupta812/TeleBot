...
@borg.on(admin_cmd(sudo_cmd(pattern=("sg ?(.*)"))))
async def _(event):
   if event.fwd_from:
      return 
...
@borg.on(admin_cmd(sudo_cmd(pattern=("fakemail ?(.*)"))))
async def _(event):
   if event.fwd_from:
      return 
   chat = "@fakemailbot"
...
@borg.on(admin_cmd(sudo_cmd(pattern=("mailid ?(.*)"))))
async def _(event):
   if event.fwd_from:
      return 
   chat = "@fakemailbot"
...
@borg.on(admin_cmd(sudo_cmd(pattern=("ub ?(.*)"))))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@borg.on(admin_cmd(sudo_cmd(pattern=("gid ?(.*)"))))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
