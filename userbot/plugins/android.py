...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"device(?: |$)(\S*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)")))
...
@telebot.on(admin_cmd(sudo_cmd(pattern=r"twrp(?: |$)(\S*)")))
